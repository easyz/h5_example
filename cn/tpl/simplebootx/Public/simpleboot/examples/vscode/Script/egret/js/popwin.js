...
showWin: function(width, height, title, src,call) {
		...
		{
			document.getElementById("mobile_popiframe").style.backgroundImage="url("+examplePath+"bg/"+selectNode.backgroundColor+".jpg)";
		}else{
